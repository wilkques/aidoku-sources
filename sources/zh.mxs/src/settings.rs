...
pub fn get_base_url() -> String {
    ...
    if base_url.is_empty() {
        // get all urls https://www.freexcomic.com
        let default_base_url = "https://www.mxs13.cc";

        defaults_set(BASE_URL_KEY, DefaultValue::String(String::from(default_base_url)));
